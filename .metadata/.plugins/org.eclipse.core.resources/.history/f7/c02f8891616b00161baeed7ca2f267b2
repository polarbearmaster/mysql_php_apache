...
class date_pulldown {
    ...
    function day_select($filedname, $datearray) {
        $out = "<select name=\"$filedname"."['mday']\">\n";
        for ($x=1;$x<=31;$x++) {
    ...
    function month_select($filedname, $datearray) {
        $out = "<select name=\"$filedname"."['mon']\">\n";
        for ($x=1;$x<=12;$x++) {
    ...
    function year_select($filedname, $datearray) {
        $out = "<select name=\"$filedname"."['year']\">\n";
